...
type UpdateGpuStatusRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The unique resource name of the GPU to update.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// status is the new status for the GPU.
	Status *GpuStatus `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	// resource_version for optimistic concurrency control.
	// If set and does not match the current version, the update is rejected.
	//
	// Optional. Defaults to unset (no concurrency check).
	...
	// opts contains the options for the update.
	Opts          *UpdateOptions `protobuf:"bytes,4,opt,name=opts,proto3" json:"opts,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_device_v1alpha1_gpu_proto_rawDesc = "" +
	...
	"\x03gpu\x18\x01 \x01(\v2\x1f.nvidia.nvsentinel.v1alpha1.GpuR\x03gpu\x12=\n" +
	"\x04opts\x18\x02 \x01(\v2).nvidia.nvsentinel.v1alpha1.UpdateOptionsR\x04opts\"\xd5\x01\n" +
	"\x16UpdateGpuStatusRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12=\n" +
	"\x06status\x18\x02 \x01(\v2%.nvidia.nvsentinel.v1alpha1.GpuStatusR\x06status\x12)\n" +
	"\x10resource_version\x18\x03 \x01(\tR\x0fresourceVersion\x12=\n" +
	"\x04opts\x18\x04 \x01(\v2).nvidia.nvsentinel.v1alpha1.UpdateOptionsR\x04opts\"\x83\x01\n" +
...
var file_device_v1alpha1_gpu_proto_depIdxs = []int32{
	...
	10, // 18: nvidia.nvsentinel.v1alpha1.UpdateGpuStatusRequest.status:type_name -> nvidia.nvsentinel.v1alpha1.GpuStatus
