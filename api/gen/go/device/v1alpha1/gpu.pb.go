...
const file_device_v1alpha1_gpu_proto_rawDesc = "" +
	...
	"\tWatchGpus\x12(.nvidia.device.v1alpha1.WatchGpusRequest\x1a).nvidia.device.v1alpha1.WatchGpusResponse0\x01BBZ@github.com/nvidia/device-api/api/gen/go/device/v1alpha1;v1alpha1b\x06proto3"
