...
const file_device_v1alpha1_gpu_proto_rawDesc = "" +
	"\n" +
	"\x19device/v1alpha1/gpu.proto\x12\x16nvidia.device.v1alpha1\x1a\x1fgoogle/protobuf/timestamp.proto\"i\n" +
	"\n" +
	"ObjectMeta\x12\x12\n" +
	...
	"\x06object\x18\x02 \x01(\v2\x1b.nvidia.device.v1alpha1.GpuR\x06object2\xa8\x02\n" +
	"\n" +
	"GpuService\x12W\n" +
	...
	"\tWatchGpus\x12(.nvidia.device.v1alpha1.WatchGpusRequest\x1a).nvidia.device.v1alpha1.WatchGpusResponse0\x01BBZ@github.com/nvidia/nvsentinel/api/gen/go/device/v1alpha1;v1alpha1b\x06proto3"
...
var file_device_v1alpha1_gpu_proto_depIdxs = []int32{
	...
	15, // 6: nvidia.device.v1alpha1.Condition.last_transition_time:type_name -> google.protobuf.Timestamp
	...
	9,  // 13: nvidia.device.v1alpha1.GpuService.GetGpu:input_type -> nvidia.device.v1alpha1.GetGpuRequest
	11, // 14: nvidia.device.v1alpha1.GpuService.ListGpus:input_type -> nvidia.device.v1alpha1.ListGpusRequest
	13, // 15: nvidia.device.v1alpha1.GpuService.WatchGpus:input_type -> nvidia.device.v1alpha1.WatchGpusRequest
	10, // 16: nvidia.device.v1alpha1.GpuService.GetGpu:output_type -> nvidia.device.v1alpha1.GetGpuResponse
	12, // 17: nvidia.device.v1alpha1.GpuService.ListGpus:output_type -> nvidia.device.v1alpha1.ListGpusResponse
	14, // 18: nvidia.device.v1alpha1.GpuService.WatchGpus:output_type -> nvidia.device.v1alpha1.WatchGpusResponse
