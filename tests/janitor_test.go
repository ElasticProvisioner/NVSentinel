...
func TestJanitorNodeLocking(t *testing.T) {
	...
	feature.Assess("RebootNode and GPUReset for same node run sequentially", func(ctx context.Context, t *testing.T, c *envconf.Config) context.Context {
		...
		startTimeReboot, completionTimeReboot := getStartAndCompletionTimes(t, rebootNodeCR)
		startTimeReboot2, completionTimeReboot2 := getStartAndCompletionTimes(t, rebootNodeCR2)
		startTimeReset, completionTimeReset := getStartAndCompletionTimes(t, gpuResetCR)
...
func getStartAndCompletionTimes(t *testing.T, maintenanceCR *unstructured.Unstructured) (time.Time, time.Time) {
